...
const Trainers = () => {
  return (
    <div id='trainers-page'>
      ...
      <div id='outlined-mobile' className='outlined-text-container'>
        <h1 className='normal-text'>CONSIGUE RESULTADOS REALES</h1>
        <h1 className='text-shadow'>CONSIGUE RESULTADOS REALES</h1>
      </div>
      <p id='info-text-mobile'>Planeas presentarte a exámenes de oposiciones o necesitas encontrar tu propio camino en el mundo de la halterofilia, nosotros somos el equipo de profesionales que necesitas para cumplir tus objetivos.</p>
