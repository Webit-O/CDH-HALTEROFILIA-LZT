...
const About = () => {
  return (
    <div id='about-container'>
      ...
      <div>
        <p>Somos especialistas en ejercicios de habilidades y destreza relacionados con el deporte: entrenamiento articular, óseo y tendinoso para el rendimiento, la prevención y regeneración de lesiones.
